...
namespace InmobiliariaService
{
    public class DAOBase
    {
        ...
        internal const string connStr = @"Data Source=SQL5004.myWindowsHosting.com;Initial Catalog=DB_9BA2A5_PaceMaker;User Id=DB_9BA2A5_PaceMaker_admin;Password=q1w2e3r4;";
